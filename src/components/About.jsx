          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
            ...
            <div className="space-y-6 text-gray-300 leading-relaxed">
              <p className="text-lg">
                ...
                at <span className="text-white font-semibold">Dwarkadas J. Sanghvi College of Engineering</span>, maintaining a
            ...
            <div className="w-full md:w-1/5 flex-shrink-0">
              <img
                src={profileImg}
                alt="Daksh Goyal"
                className="w-full h-auto object-cover rounded-full border-4 border-purple-400 shadow-lg"
              />
            </div>
